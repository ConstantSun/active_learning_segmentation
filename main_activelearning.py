...
def train_net(
    ...
    dataset = RestrictedDataset(dir_img, dir_mask, train=True)
    data_test = RestrictedDataset(imgs_dir=dir_img_test, masks_dir=dir_mask_test, train=False, scale=img_scale)
