...
# ailab
dir_img = "/data.local/all/hangd/dynamic_data/onesixteenth/imgs/"
dir_mask = '/data.local/all/hangd/dynamic_data/onesixteenth/masks/'
    ...
    for epoch in range(epochs):
        ...
        if test_score_iou > best_test_iou_score:
            ...
            torch.save(net.state_dict(),
                       dir_checkpoint + f'best_CP_epoch{epoch + 1}_one16th_.pth')
