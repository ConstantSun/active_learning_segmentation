...
from fetch_data_for_next_phase import get_pool_data, update_training_pool_ids_2, update_training_pool_ids_random
...
def train_net(
    ...
    batch_size = 4
    lr = 1e-5
    writer = SummaryWriter(comment=f'_{net.__class__.__name__}_LR_{lr}_BS_{batch_size}_random_ACQUISITION')
    global_step = 0

    logging.basicConfig(filename="./logging_one32nd_random.txt",
                        filemode='a',
    ...
    training_pool_ids_path = "data_one32nd_random.json"
    ...
    for phase in range(num_phases):
        ...
        update_training_pool_ids_random(training_pool_ids_path, all_training_data)
...
if __name__ == '__main__':
    ...
    args = get_args()
    dir_ckp = "./check_point_active/random/"
