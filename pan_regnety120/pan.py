...
from pan_regnety120.decoder import PANDecoder
from pan_regnety120.encoders import get_encoder
from pan_regnety120.base import SegmentationModel
from pan_regnety120.base import SegmentationHead
...
class PAN(SegmentationModel):
    ...
    def __init__(
            self,
            encoder_name: str = "timm-regnety_120",
