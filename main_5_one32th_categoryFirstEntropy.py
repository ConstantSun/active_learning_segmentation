...
def train_net(
    ...
    batch_size = 4
    lr = 1e-5
    writer = SummaryWriter(comment=f'_{net.__class__.__name__}_LR_{lr}_BS_{batch_size}_categoryFirstEntropy_ACQUISITION')
    global_step = 0

    logging.basicConfig(filename="./logging_one32nd_category.txt",
                        filemode='a',
    ...
    for phase in range(num_phases):
        ...
        update_training_pool_ids_2(net, training_pool_ids_path, all_training_data, device, acquisition_func="cfe")
...
if __name__ == '__main__':
    ...
    args = get_args()
    dir_ckp = "./check_point_active/categoryfirst_real/"
